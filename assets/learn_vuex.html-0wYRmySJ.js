import{_ as e,c as n,a,o as i}from"./app-D6QQlZNp.js";const t={};function l(r,s){return i(),n("div",null,s[0]||(s[0]=[a(`<h1 id="vuex中存什么" tabindex="-1"><a class="header-anchor" href="#vuex中存什么"><span>vuex中存什么？</span></a></h1><p>多个组件共享数据，才能存在vuex中。 某个组件中的私有数据，依旧存在data中。 例如:</p><ul><li>登录的用户名 在首页、个人中心、结算页面使用，所以用户名应该存在vuex中；</li><li>文章的详情数据，只有在文章详情页查看，在自身的data中声明。</li></ul><h1 id="安装-vuex-下载" tabindex="-1"><a class="header-anchor" href="#安装-vuex-下载"><span>安装 vuex（下载）</span></a></h1><p>npm install vuex@next --save</p><h1 id="创建-store实例-初始化仓库" tabindex="-1"><a class="header-anchor" href="#创建-store实例-初始化仓库"><span>创建 store实例/初始化仓库</span></a></h1><p>src/store/index.ts</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">import {createStore} from &#39;vuex&#39;</span>
